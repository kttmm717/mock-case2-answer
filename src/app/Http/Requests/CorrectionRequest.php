...
class CorrectionRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'new_break_in' => 'required|date_format:H:i|after:new_clock_in|before:new_break_out',
            'new_break_out' => 'required|date_format:H:i|after:new_break_in|before:new_break_out',
            'new_break2_in' => 'required|date_format:H:i|after:new_clock_in|before:new_break2_out',
            'new_break2_out' => 'required|date_format:H:i|after:new_break2_in|before:new_clock_out',
            'comment' => 'required',
        ];
    }
